...
const CHART_OPTIONS: ChartOption[] = [
    // Trend
    { value: 'line', label: 'Line', icon: 'trending_up', lib: 'chartjs', group: 'trend' },
    { value: 'area', label: 'Area', icon: 'trending_down', lib: 'chartjs', group: 'trend' },
    // Compare
    { value: 'bar', label: 'Bar', icon: 'bar_chart', lib: 'chartjs', group: 'compare' },
    { value: 'horizontal_bar', label: 'H-Bar', icon: 'format_align_left', lib: 'chartjs', group: 'compare' },
    { value: 'stacked_bar', label: 'Stacked', icon: 'layers', lib: 'chartjs', group: 'compare' },
    { value: 'waterfall', label: 'Waterfall', icon: 'waterfall_chart', lib: 'plotly', group: 'compare' },
    // Composition
    { value: 'pie', label: 'Pie', icon: 'pie_chart', lib: 'chartjs', group: 'composition' },
    { value: 'doughnut', label: 'Donut', icon: 'donut_large', lib: 'chartjs', group: 'composition' },
    { value: 'treemap', label: 'Treemap', icon: 'account_tree', lib: 'plotly', group: 'composition' },
    { value: 'sunburst', label: 'Sunburst', icon: 'light_mode', lib: 'plotly', group: 'composition' },
    // Advanced
    { value: 'scatter', label: 'Scatter', icon: 'scatter_plot', lib: 'chartjs', group: 'advanced' },
    { value: 'bubble', label: 'Bubble', icon: 'bubble_chart', lib: 'chartjs', group: 'advanced' },
    { value: 'radar', label: 'Radar', icon: 'radar', lib: 'chartjs', group: 'advanced' },
    { value: 'heatmap', label: 'Heatmap', icon: 'grid_view', lib: 'plotly', group: 'advanced' },
    { value: 'box_plot', label: 'Box', icon: 'candlestick_chart', lib: 'plotly', group: 'advanced' },
    { value: 'violin', label: 'Violin', icon: 'graphic_eq', lib: 'plotly', group: 'advanced' },
];
