...
export function ForecastPanel({ projectId, isOpen, onClose, activeKPIs }: ForecastPanelProps) {
                ...
                <div className="p-6 flex flex-col gap-6 overflow-y-auto">
                    {!showCanvas ? (
                        ...
                        <div className="flex-1 flex flex-col min-h-[600px]">
                            ...
                            <div className="flex-1 border border-slate-200 rounded-2xl overflow-hidden bg-white shadow-sm p-4">
                                <DashboardErrorBoundary label="Forecast Canvas">
                                    <StrategyCanvas 
                                        initialContext={{
                                            goalValue: kpiHistory[kpiHistory.length - 1].value * 1.1, // Dummy goal 10% higher for visual scale
                                            actionName: "Baseline AI Projection",
                                            kpiHistory,
                                            uplift: 0 // pure baseline
                                        }}
                                    />
