...
beforeEach(() => {
    ...
    (db as any).kPIBlueprint.findUnique.mockResolvedValue({
        kpis: [{ id: 'kpi-rev', sourceTable: 'src-sales', kpiLibraryId: 'kpi-rev', kpiId: 'kpi-rev', name: 'Revenue', kpiName: 'Revenue', confidence: 1, category: 'financial', formula: 'SUM(amount)', matchedColumns: [], addedAt: new Date(), aggregations: [{ function: 'SUM', column: 'amount', sourceId: 'src-sales' }], groupBys: [] }]
    });
